                ...
                <div className="row">
                  <div className="col-md-6">
                    ...
                    <div className="detail-box">
                      ...
                      <p>
                      My Shop: Because who wants to buy a new gadget when you can rent someone else's for a few days? Students can swap their stuff too—electronics, appliances, or that random drafting table you needed once!
                      </p>
                      <a href="/about">Read More</a>
                    </div>
                  </div>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="detail-box">
                      <h1>Welcome to our shop</h1>
                      <p>
                      My Shop: The place where students can rent out their barely-used gadgets and pretend they're making money while you're just borrowing someone else's old stuff. Need a product for a few days? Don't worry, we've got a 'rental kingdom' full of electronics and random gadgets!"
                      </p>
                      <a href="/about">Read More</a>
                    </div>
                  </div>
